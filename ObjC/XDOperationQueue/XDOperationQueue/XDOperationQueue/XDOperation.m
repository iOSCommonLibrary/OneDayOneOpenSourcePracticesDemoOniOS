...
- (NSString *)description
{
    ...
    NSString *desc = [NSString stringWithFormat:@"<XDOperationQueue name:\"%@\" executing:%lu pending:%lu >",_name,(unsigned long)[_operations count],(unsigned long)[_pendingOperations count]];
